...
class Config(NamedTuple):
    ...
    epochs_actor: int       = 5                 # Actor update epochs 
    epochs_critic: int      = 3                 # Critic update epochs
    ...
    b_use_gae               = True              # Use GAE for Advantage (F: Monte Calro estimator)
    gae_lambda: float       = 0.75              # GAE lambda
